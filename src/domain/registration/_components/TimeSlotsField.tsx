            ...
            >
              ...
              <div className='w-full md:flex-1 md:basis-0'>
                <DatePickerField
                  ...
                  className='w-full'
                  onChange={(value) => {
                    onChange(slot.id, 'date', value);
                  }}
                />
              </div>

              {/* 시간 + 버튼: 한 줄 정렬, 데스크탑에서는 내용폭만 차지 */}
              <div className='flex w-full items-end gap-2 md:w-auto md:flex-none md:flex-nowrap'>
                <div className='flex-1 md:w-44 md:flex-none'>
                  <TimeSelectDropdown
                    ...
                    placeholder='0:00'
                    onSelect={(value) => {
                      onChange(slot.id, 'startTime', value);
                    }}
                  />
                </div>

                <span className='flex h-[54px] w-6 items-center justify-center self-end text-gray-300'>
                  -
                </span>
                ...
                <div className='flex-1 md:w-44 md:flex-none'>
                  <TimeSelectDropdown
                    ...
                    placeholder='0:00'
                    onSelect={(value) => {
                      onChange(slot.id, 'endTime', value);
                    }}
                  />
                </div>

                <div className='ml-4 flex h-[54px] shrink-0 items-center self-end'>
                  {index === 0 ? (
