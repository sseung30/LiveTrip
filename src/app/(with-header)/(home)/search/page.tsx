...
import SearchResult from '@/domain/activity/components/search/SearchResult';
import SearchResultSkeleton from '@/domain/activity/components/search/SearchResultSkeleton';
